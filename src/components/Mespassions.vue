<template>
  <!-- Texte image -->
  <section ref="referenceSizeDiv"
    :class="['kp_content--block', 'kp_z-index', dynamicClasses, 'kp_changed__id', `kp_${context}`, 'kp_item__window', windowStateClass]"
    :id="`kp_${context}`">
    ...
    <FakeMenu></FakeMenu>
    <div class="onglets">
      <ul class="containers-liste-onglets  kp_folder-liste">
        <li :class="[{ active: activeTab === 1, 'selected-project': activeTab === 1 }, 'kp_folder-li']"
          @click="setActiveTab(1)">Pokémon</li>
        <li :class="[{ active: activeTab === 2, 'selected-project': activeTab === 2 }, 'kp_folder-li']"
    ...
    <div :class="['kp_content--block--content', 'kp_element--enable']">
      ...
      <div class="container-passions">
        ...
        <!-- ----------------- -->
        <!-- POkémon -->
        <div class="onglet  onglet--1" v-show="activeTab === 1">
          <article class="container-passion  kp_card">
            <div class="texte-passion">
              <div class="kp_texte-carte">
                <h2 class="kp_p-black kp_bold  kp_titre-passion">POKéMON</h2>
                <p class="kp_p-black">
                  Ayant grandi dans les années 90, je n'ai pas échappé à la folie POKéMON.<br>
                  Après avoir développé deux jeux amateurs en Ruby pour honorer la <span
                    class="kp_bold  kp_bold--passion">passion de mon enfance</span>, cela m'a laissé un attachement
                  particulier.<br>
                  J'ai conservé ma collection de cartes d'enfance, qui contient des raretés toujours très recherchées de
                  nos jours.
                  <br>
                  <br>
                  Pour découvrir <span class="kp_bold  kp_bold--passion">le fangame que je développe</span> sur mon
                  temps libre, rendez-vous sur le site de <span class="kp_bold  kp_bold--passion">POKéMON Opale</span>
                  en cliquant sur le lien ce-dessous.
                </p>
                <a class="btn-windows-xp  btn-windows-xp-ok" href="http://www.pokemonopale.fr" target="_blank"><span
                    class="btn-windows-xp--texte">Découvrir mon fangame</span></a>
              </div>
            </div>
            ...
            <div class="passion-demonstaration">
              <div class="part--passion">
                ...
                <p class="kp_p-black kp_bold  hide-desktop  text-passion">Déplacez votre doigt sur la carte pour la voir
                  briller.</p>
              </div>
              <div class="part--passion"></div>
            </div>

            <div class="passion-demonstaration  passion-demonstaration--pokemon">
              <!-- Carte -->
              <div class="part--passion  part--passion-pokemon">
                <article class="kp_card-pokemon" ref="cardPokemon">
                  <div class="kp_card-pokemon--container">
                    <div class="opencard" ref="cardcontainer">
                      <img class="kp_card-pokemon--img" :src="Pokemoncard2" alt="carte Pokémon">
                      <div class="kp_card-pokemon--glow" ref="cardGlow"></div>
                      <div class="kp_card-pokemon--holo" ref="cardHolo"></div>
                      <img class="kp_card-pokemon--img kp_card-pokemon--cadre  kp_card-pokemon--dracaufeu"
                        :src="Pokemoncard3" alt="carte Pokémon" ref="dracaufeu">
                    </div>
                   
                    <img class="kp_card-pokemon--img kp_card-pokemon--cadre" :src="Pokemoncard1" alt="carte Pokémon"
                      ref="carCadre">
                    <div class="kp_card-pokemon--glow2" ref="cardGlow2"></div>
                  </div>
                </article>
                <article class="card-face card-back">
                  <img :src="PokemonBack" alt="Dos de la carte Pokémon">
                </article>
              </div>
              <!-- Game Boy -->
              <div class="part--passion">
                <p class="kp_p-black kp_bold  hide-desktop">Des images de POKéMON Opale</p>
                <div class="kp_gameboy" ref="gameboy">
                  <img class="kp_gameboy--screen  fight-delay" :src="screen" alt="Gameboy">
                  <img class="kp_gameboy--screen  title-delay" :src="screentitle" alt="Gameboy">
                  <img class="kp_gameboy--img" :src="Gameboy" alt="Gameboy">
                  <img class="kp_gameboy--on" :src="Gameboyon" alt="Gameboy">
                </div>
              </div>
            </div>
        ...
        <!-- ----------------- -->
        <!-- Sports -->
        <div class="onglet  onglet--2" v-show="activeTab === 2">

          <article class="container-passion  kp_card">
            <div class="texte-passion">
              <div class="kp_texte-carte">
                <h2 class="kp_p-black kp_bold  kp_titre-passion">Le sport</h2>
                <p class="kp_texte kp_p-black">
                  Depuis toujours, le sport occupe une place importante dans ma vie, avec un attachement particulier aux
                  équipes qui font vibrer Bordeaux.
                  <br><br>Que ce soit les <span class="kp_bold  kp_bold--passion">Boxers de Bordeaux</span> sur la
                  glace, avec l'énergie et la combativité du hockey, ou <span class="kp_bold  kp_bold--passion">l'Union
                    Bordeaux Bègles (UBB)</span> sur le terrain de rugby, ces équipes représentent pour moi bien plus
                  que des matchs&nbsp;: elles incarnent l'esprit de camaraderie, de <span
                    class="kp_bold  kp_bold--passion">dépassement de soi</span> et de fidélité à une ville.
                  <br>Bien sûr, je ne manque jamais une occasion de suivre les grands rendez-vous de football, un autre
                  sport qui me passionne et qui complète <span class="kp_bold  kp_bold--passion">mon univers
                    sportif</span>.
                </p>
              </div>
            </div>
          ...
          <div class="passion-demonstaration">
            <div class="part--passion  part--passion-sport">
              <div class="flippassion">
                <div class="recto">
                  <img class="img-sport-passion" :src="ubb" alt="Logo UBB">
                </div>
                <div class="verso">
                  <img class="img-sport-passion" :src="ubbphoto" alt="UBB">
                </div>
              </div>
            </div>
            <div class="part--passion  part--passion-sport">
              <div class="flippassion">
                <div class="recto">
                  <img class="img-sport-passion  boxersdebordeaux" :src="boxers" alt="Logo BOXERS">
                </div>
                <div class="verso">
                  <img class="img-sport-passion" :src="boxersphoto" alt="Boxers">
                </div>
              </div>
            </div>
          </div>
        ...
        <!-- ----------------- -->
        <!-- Sports -->
        <div class="onglet  onglet--3" v-show="activeTab === 3">
          <article class="container-passion  kp_card">
            <div class="texte-passion">
              <div class="kp_texte-carte">
                <h2 class="kp_p-black kp_bold  kp_titre-passion">Le dessin et l’art numérique</h2>
                <p class="kp_texte kp_p-black">
                  Le dessin a toujours été un moyen d'expression pour moi, un espace de liberté où chaque trait raconte
                  une histoire.
                  <br>Au fil du temps, <span class="kp_bold  kp_bold--passion">cette passion a évolué</span> pour
                  embrasser les outils numériques, ouvrant un nouveau champ de possibilités créatives.
                  <br>Aujourd'hui, <span class="kp_bold  kp_bold--passion">le dessin vectoriel</span> occupe une place
                  de choix dans mon univers artistique&nbsp;: précis, modulable et épuré, il me permet de <span
                    class="kp_bold  kp_bold--passion">jouer avec les formes et les couleurs</span> avec une flexibilité
                  sans limites.
                  <br><span class="kp_bold  kp_bold--passion">Cet art numérique</span> est devenu pour moi une manière
                  d’allier technologie et créativité, et d’explorer sans cesse de nouveaux horizons visuels.
                  <br>
                  <br>D'ailleurs, si vous aimez ce style créatif, je vous invite à découvrir Tookek.fr en cliquant si
                  dessous.
                </p>

                <a class="btn-windows-xp  btn-windows-xp-ok" href="http://www.tookek.fr" target="_blank"><span
                    class="btn-windows-xp--texte">Découvrir Tookek.fr</span></a>
              </div>
            </div>
          </article>
          <div class="passion-demonstaration">
            <div class="part--passion  part--passion-dessin">
              <img class="img-dessin-passion" :src="tookek" alt="tookek.fr">
            </div>
          </div>
        </div>
...
import Gameboy from '@/assets/images/gameboycolorpassion.png';
import Gameboyon from '@/assets/images/gameboyon.png';
import screentitle from '@/assets/images/opale/opaletitle.gif';
import screen from '@/assets/images/opale/opalefight.gif';

import ubb from '@/assets/images/ubb.svg';
...
export default {
  ...
  computed: {
    dynamicClasses() {
      return this.divWidth < 960 ? 'smalldiv' : 'largediv';
    },
  },
  watch: {
    divWidth(newWidth) {
  ...
  methods: {
    ...
    initResizeObserver() {
      ...
      this.resizeObserver.observe(this.$refs.referenceSizeDiv);
    },
    ...
    initCardInteractions() {
      ...
      const dracaufeuLayer = this.$refs.dracaufeu;
      ...
      const updateGlowEffect = (x, y, elRect) => {
        ...
        // carCadre.style.transform = `rotateX(${angleY}deg) rotateY(${angleX}deg)`;
        // dracaufeuLayer.style.transform = `translateZ(20px) rotateX(${angleY * 0.5}deg) rotateY(${angleX * 0.5}deg)`;
      };
      ...
      const resetCardPosition = () => {
        ...
        dracaufeuLayer.style.transform = '';
...
.container-passions {
  ...
  filter: drop-shadow(2px 2px 4px rgba(0, 0, 0, 0.464));
}
...
.part--passion-pokemon {
  transform: rotateY(180deg);
  /* Retourne le dos */
  animation: rotatecard 1.5s forwards cubic-bezier(0.025, 0.1, 0.15, 1) 1s;
...
.kp_gameboy--on {
  ...
  top: 17.7%;
  left: 8.4%;
  animation: blink-91fc8996 2s infinite;
  filter: drop-shadow(0px 0px 4px #ff5858) brightness(1.2);
}
...
.title-delay {
  animation: fight 9.60s forwards;
}
...
.part--passion-sport:hover {
  width: 100%;
  max-width: 500px;
}

.part--passion:hover .flippassion {
  transform: rotateY(180deg);
}
...
/* -------------------- */
.smalldiv .part--passion,
.smalldiv .text-passion {
  width: 100%;
}
...
.smalldiv .kp_content--block--content.kp_element--enable {
  background: #FFFFFF;
}

.smalldiv .kp_folder-liste {
  background: #FFFFFF;
  border-bottom: solid 1px #e0dccb;
}

.smalldiv .passion-demonstaration--pokemon {
  gap: 50px;
}
